...
- **Tone:** Confident, insider, contrarian, and concise. (See [brand-rules.md](brand-rules.md) for full voice guidelines.)
- **Structure:** 1 Hook Slide, body slides sufficient to cover the concept, and 1 CTA Slide. (See [frameworks.md](frameworks.md) for framework/format options.)
